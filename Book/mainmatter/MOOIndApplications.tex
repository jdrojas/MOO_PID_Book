...
Three different tuning rules were considered: the SIMC method~\cite{Skogestad2003}, the method by Rovira~\cite{Rovira1969a} and the method by Murril~\cite{Murril1967}. The equations were implemented as presented in \cite{odwyer2006}. For the case of the Rovira and Murril method, the model in \eqref{eq:TFCSTH} was reduced to a first order model using the Half-Rule in \cite{Skogestad2003}:
\begin{equation}
