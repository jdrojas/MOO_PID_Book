...
\abstract{In this chapter the metrics used for performance and robustness are presented for the case of \gls{pid} control. Special attention is given to the integral measure of error.  Also the tradeoffs that arises in a controlled system are considered, for example the well known relationship between servo and regulation response, or between performance and robustness. This tradeoffs are what gives meaning to the multiobjective approach that will be taken in the rest of the book.}
...
\end{equation}
%
is used as main indication of the \emph{smoothness} of the control action for input changes.
