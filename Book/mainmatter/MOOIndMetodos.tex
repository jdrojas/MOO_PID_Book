...
For these reasons, once the Pareto is found, it may be useful to accomplished some tasks to help the decision maker:
\begin{itemize}
...
%
\textbf{To do}
\subsection{The Pareto Front as data}
\label{sec:ParetoData}
%
\textit{\textbf{To do}}

\subsection{The Pareto Front as the basis for a decision tool}
