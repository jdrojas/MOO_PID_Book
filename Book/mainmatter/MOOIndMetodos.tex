...
By definition, all points in the Pareto Front are equally optimal, therefore, once the Pareto is found, it may be useful to accomplished some tasks:
\begin{itemize}
	...
	\item Introduce a final restriction in order to use the Pareto Front as the basis of the decision.
\end{itemize}
