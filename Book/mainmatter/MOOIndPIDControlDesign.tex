...
When dealing with \gls{pid} tuning, it is common to define a metric either to optimize the parameters based on that metric, or as a measure to check how well the tuning behaves with respect to other set of parameters.
