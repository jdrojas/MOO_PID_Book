...
Ac = pi*D^2*Hc + pi*D^2/4;% jacket heat transfer area, A c = π D H c + π D 2 /4 m 2 ,
...
Pcp = 414;% : heating fluid pump discharge pressure, P cp = 414 kpa,
Pcr = 138;% : heating fluid system return pressure, P cr = 138 kpa;
Rc = 5.5e7; %heating system pipe nominal flow resistance, R c = 5.5 × 10 7 kPa/(m 3 /s) 2
...
UL0 = 71.72;
UT0 = 89;
Tin = 24; % fluid inlet temperature, 22 ◦ C ≤ T i ≤ 26 ◦ C, temperature T i n = 24 ◦ C,
Tci = 900; %heating fluid inlet temperature, T ci = 320 ◦ C,
